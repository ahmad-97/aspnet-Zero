...
$webMvcFolder = Join-Path $slnFolder "src/Experts.First_Project.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Experts.First_Project.Web.Public"
...
dotnet restore Experts.First_Project.Web.sln
