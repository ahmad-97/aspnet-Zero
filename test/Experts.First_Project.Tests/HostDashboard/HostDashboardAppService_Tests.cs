...
using Experts.First_Project.MultiTenancy.HostDashboard;
...
namespace Experts.First_Project.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(First_ProjectDbContext context, SubscriptionPayment subscriptionPayment)
        {
