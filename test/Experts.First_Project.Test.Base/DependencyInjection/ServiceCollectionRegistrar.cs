...
namespace Experts.First_Project.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<First_ProjectDbContext>>()
            ...
            new First_ProjectDbContext(builder.Options).Database.EnsureCreated();
        }
