...
using Experts.First_Project.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : First_ProjectAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Experts.First_Project",
