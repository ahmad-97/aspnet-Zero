...
using Experts.First_Project.UiCustomization;
...
{
    public class SessionAppService : First_ProjectAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = First_ProjectConsts.Currency,
                        CurrencySign = First_ProjectConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = First_ProjectConsts.AllowTenantsToChangeEmailSettings,
