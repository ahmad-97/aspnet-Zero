...
using Experts.First_Project.Migrations.Seed.Host;
...
namespace Experts.First_Project.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : First_ProjectAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<First_ProjectDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{First_ProjectConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{First_ProjectConsts.ConnectionStringName}", constring);
        }
