...
using Experts.First_Project.Auditing.Exporting;
...
using EntityHistoryHelper = Experts.First_Project.EntityHistory.EntityHistoryHelper;

namespace Experts.First_Project.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : First_ProjectAppServiceBase, IAuditLogAppService
    {
