...
namespace Experts.First_Project.Web.Authentication.JwtBearer
{
    public class First_ProjectJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public First_ProjectJwtSecurityTokenHandler()
        {
