...
using Experts.First_Project.Web.Authentication.JwtBearer;
using Experts.First_Project.Web.Authentication.TwoFactor;
using Experts.First_Project.Web.Chat.SignalR;
using Experts.First_Project.Web.Common;
using Experts.First_Project.Web.Configuration;
using Experts.First_Project.Web.DashboardCustomization;

namespace Experts.First_Project.Web
{
    [DependsOn(
        typeof(First_ProjectApplicationModule),
        typeof(First_ProjectEntityFrameworkCoreModule),
    ...
    public class First_ProjectWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public First_ProjectWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(First_ProjectApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(First_ProjectWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(First_ProjectWebCoreModule).Assembly);
        }
