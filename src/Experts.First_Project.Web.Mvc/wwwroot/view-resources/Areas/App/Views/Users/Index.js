                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            visible: function () {
                                return _dynamicEntityPropertyManager.canShow('Experts.First_Project.Authorization.Users.User');
                            },
                            action: function (data) {
                                _dynamicEntityPropertyManager.modal.open({
                                    entityFullName: 'Experts.First_Project.Authorization.Users.User',
