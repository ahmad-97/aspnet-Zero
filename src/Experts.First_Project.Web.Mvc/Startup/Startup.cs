...
using Experts.First_Project.Schemas;
using Experts.First_Project.Web.Chat.SignalR;
using Experts.First_Project.Web.Common;
using Experts.First_Project.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Experts.First_Project.Web.IdentityServer;
using Experts.First_Project.Web.Swagger;
using Stripe;
...
using Experts.First_Project.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = Experts.First_Project.Identity.SecurityStampValidatorCallback;

namespace Experts.First_Project.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<First_ProjectWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "First_Project API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Experts.First_Project.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "First_Project API", Version = "v1"});
                ...
                var applicationXml = $"Experts.First_Project.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Experts.First_Project.Web.Core.xml";
