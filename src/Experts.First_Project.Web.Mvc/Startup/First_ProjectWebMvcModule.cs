...
namespace Experts.First_Project.Web.Startup
{
    ...
    public class First_ProjectWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public First_ProjectWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(First_ProjectWebMvcModule).GetAssembly());
        }
