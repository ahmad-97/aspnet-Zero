...
namespace Experts.First_Project.Web.Areas.App.Views.Shared.Themes.Theme2.Components.AppTheme2Brand
{
    public class AppTheme2BrandViewComponent : First_ProjectViewComponent
    {
