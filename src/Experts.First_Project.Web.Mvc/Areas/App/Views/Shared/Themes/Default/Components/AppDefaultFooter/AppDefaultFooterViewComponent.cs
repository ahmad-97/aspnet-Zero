...
namespace Experts.First_Project.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultFooter
{
    public class AppDefaultFooterViewComponent : First_ProjectViewComponent
    {
