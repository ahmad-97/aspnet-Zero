...
using Experts.First_Project.Web.DashboardCustomization;


namespace Experts.First_Project.Web.Areas.App.Startup
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                    viewFileRoot + "DailySales",
                    jsAndCssFileRoot + "DailySales/DailySales.min.js",
                    jsAndCssFileRoot + "DailySales/DailySales.min.css"));

            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                    viewFileRoot + "ProfitShare",
                    jsAndCssFileRoot + "ProfitShare/ProfitShare.min.js",
                    jsAndCssFileRoot + "ProfitShare/ProfitShare.min.css"));
  
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Host.TopStats,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            WidgetViewDefinitions.Add(First_ProjectDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
                    First_ProjectDashboardCustomizationConsts.Widgets.Host.RecentTenants,
