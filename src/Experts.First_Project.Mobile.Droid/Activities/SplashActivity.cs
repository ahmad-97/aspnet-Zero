...
using Experts.First_Project.Localization.Resources;
using Experts.First_Project.ViewModels.Base;
using Plugin.Connectivity;
using Process = Android.OS.Process;

namespace Experts.First_Project.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<First_ProjectXamarinAndroidModule>();
