...
namespace Experts.First_Project.Core.Base
{
    public abstract class First_ProjectQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected First_ProjectQueryBase(string fieldName,
