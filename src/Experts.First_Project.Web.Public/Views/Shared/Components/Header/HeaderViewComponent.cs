...
using Experts.First_Project.Web.Public.Startup;
using Experts.First_Project.Web.Session;

namespace Experts.First_Project.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : First_ProjectViewComponent
    {
