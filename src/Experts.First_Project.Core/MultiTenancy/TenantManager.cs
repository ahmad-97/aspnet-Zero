...
using Experts.First_Project.MultiTenancy.Demo;
...
namespace Experts.First_Project.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(First_ProjectConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(First_ProjectConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
