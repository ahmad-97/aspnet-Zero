...
{
    public class StripeGatewayManager : First_ProjectServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "First_Project";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + First_ProjectConsts.Currency;
        }
