namespace Experts.First_Project.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_TestEntities_Update = "Pages.TestEntities.Update";
        ...
        public const string Pages_Governatates = "Pages.Governatates";
        public const string Pages_Governatates_Create = "Pages.Governatates.Create";
        public const string Pages_Governatates_Edit = "Pages.Governatates.Edit";
        public const string Pages_Governatates_Delete = "Pages.Governatates.Delete";
