...
namespace Experts.First_Project.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var TestEntites = pages.CreateChildPermission(AppPermissions.Pages_TestEntities, L("TestEntities"));
            TestEntites.CreateChildPermission(AppPermissions.Pages_TestEntities_Create, L("CreateNewTestEntity"));
            TestEntites.CreateChildPermission(AppPermissions.Pages_TestEntities_Update, L("EditTestEntity"));
            TestEntites.CreateChildPermission(AppPermissions.Pages_TestEntities_Delete, L("DeleteTestEntity"));

            //var createTestEntity = TestEntites.CreateChildPermission(AppPermissions.Pages_TestEntities_Update, L("EditTestEntity"));
            //createTestEntity.CreateChildPermission(AppPermissions.pages.Pages_TestEntities_Create_M1,L("Create M1"));
            //createTestEntity.CreateChildPermission(AppPermissions.pages.Pages_TestEntities_Create_M2,L("Create M2"));
            ...
            var governatates = pages.CreateChildPermission(AppPermissions.Pages_Governatates, L("Governatates"));
            governatates.CreateChildPermission(AppPermissions.Pages_Governatates_Create, L("CreateNewGovernatate"));
            governatates.CreateChildPermission(AppPermissions.Pages_Governatates_Edit, L("EditGovernatate"));
            governatates.CreateChildPermission(AppPermissions.Pages_Governatates_Delete, L("DeleteGovernatate"));
        ...
        {
            return new LocalizableString(name, First_ProjectConsts.LocalizationSourceName);
        }
    }
}