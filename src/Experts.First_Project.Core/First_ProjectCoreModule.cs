...
using Experts.First_Project.Authorization.Ldap;
...
using Experts.First_Project.DashboardCustomization.Definitions;
using Experts.First_Project.Debugging;
using Experts.First_Project.DynamicEntityProperties;
using Experts.First_Project.Features;
...
using Experts.First_Project.Net.Emailing;
using Experts.First_Project.Notifications;
using Experts.First_Project.WebHooks;
...
{
    [DependsOn(
        typeof(First_ProjectCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class First_ProjectCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
 
            AppContext.SetSwitch("Microsoft.EntityFrameworkCore.Issue9825", true);
            Configuration.UnitOfWork.Timeout = TimeSpan.FromMinutes(20);
            ...
            First_ProjectLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = First_ProjectConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, First_ProjectMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<First_ProjectSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(First_ProjectCoreModule).GetAssembly());
        }
