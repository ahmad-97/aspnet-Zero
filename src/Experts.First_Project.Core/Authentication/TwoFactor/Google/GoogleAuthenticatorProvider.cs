...
namespace Experts.First_Project.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : First_ProjectServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Experts.First_Project", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
