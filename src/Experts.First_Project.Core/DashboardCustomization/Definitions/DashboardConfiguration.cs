    ...
    public class DashboardConfiguration
    {
        ...
        public DashboardConfiguration()
        {
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                First_ProjectDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                First_ProjectDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
