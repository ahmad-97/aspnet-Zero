...
using Experts.First_Project.Web.Startup.ExternalLoginInfoProviders;

namespace Experts.First_Project.Web.Startup
{
    [DependsOn(
        typeof(First_ProjectWebCoreModule)
    )]
    public class First_ProjectWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public First_ProjectWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(First_ProjectWebHostModule).GetAssembly());
        }
