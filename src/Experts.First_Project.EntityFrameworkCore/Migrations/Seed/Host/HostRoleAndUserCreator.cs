...
namespace Experts.First_Project.Migrations.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(First_ProjectDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            {
                sysAdminRoleForHost = _context.Roles.Add(new Role(null, StaticRoleNames.Host.SysAdmin, StaticRoleNames.Host.SysAdmin) { IsStatic = true, IsDefault = false }).Entity;
                _context.SaveChanges();
            }
