...
namespace Experts.First_Project.Migrations
{
    ...
    [Migration("20211213144406_Added_Country")]
    partial class Added_Country
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Experts.First_Project.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Experts.First_Project.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Experts.First_Project.Setup.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Experts.First_Project.Setup.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Experts.First_Project.Startup.Governatate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Experts.First_Project.Testing.TestAuditedEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Descrtipeion")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TestAuditedEntities");
                });

            modelBuilder.Entity("Experts.First_Project.Testing.TestCreationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TestCreationEntities");
                });

            modelBuilder.Entity("Experts.First_Project.Testing.TestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Experts.First_Project.Testing.TestFullAudited", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Experts.First_Project.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Experts.First_Project.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Experts.First_Project.Setup.City", b =>
                {
                    b.HasOne("Experts.First_Project.Startup.Governatate", "GovernatateFk")
                        .WithMany()
                        .HasForeignKey("GovernatateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GovernatateFk");
                });
