...
using Experts.First_Project.EntityFrameworkCore.Repositories;

namespace Experts.First_Project.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : First_ProjectRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<First_ProjectDbContext> dbContextProvider)
