...
{
    public class SubscriptionPaymentExtensionDataRepository : First_ProjectRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<First_ProjectDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
