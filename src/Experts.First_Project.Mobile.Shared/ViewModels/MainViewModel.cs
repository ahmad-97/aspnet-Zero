...
using Experts.First_Project.Controls;
using Experts.First_Project.Dto;
using Experts.First_Project.Extensions;
using Experts.First_Project.Localization;
using Experts.First_Project.UI;
using Experts.First_Project.UI.Assets;
using Experts.First_Project.Views;
using DependencyResolver = Experts.First_Project.Core.Dependency.DependencyResolver;
...
namespace Experts.First_Project.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "First_Project";
